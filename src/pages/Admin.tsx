...
export default function Admin() {
  ...
  // Admin.tsx's own handlers read this state directly, so it must actually
  // be set once data loads, not just visually implied.
  useEffect(() => {
          ...
          {(() => {
            ...
            return (
              <>
                ...
                {activeTab === "kiosks" && isOwner && <KiosksTab concepts={concepts} locations={locations} isOwner={isOwner} />}
              </>
            );
          })()}
        </div>
