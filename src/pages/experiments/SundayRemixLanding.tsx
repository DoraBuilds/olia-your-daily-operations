 ...
 * white + neon purple (#BC13FE) skin. Local preview only, not linked from any nav.
 */
...
const css = `
  ...
  .rx-badge-dot { width: 7px; height: 7px; border-radius: 50%; background: var(--neon); box-shadow: 0 0 0 4px rgba(188,19,254,0.18); flex-shrink: 0; }
  ...
  .rx-tag {
    ...
    text-transform: uppercase; color: var(--ink); background: rgba(188,19,254,0.55);
  ...
  .rx-btn-neon:hover { background: #CD4EFE; transform: translateY(-1px); box-shadow: 0 8px 22px rgba(188,19,254,0.35); }
  ...
  .rx-btn-hero:hover { background: #CD4EFE; transform: translateY(-2px); box-shadow: 0 10px 28px rgba(188,19,254,0.4); }
  .rx-btn-hero-ghost {
  ...
  /* KIOSK CARD */
  .rx-kiosk-card { background: var(--black-panel); border-radius: 20px; padding: 26px; box-shadow: var(--shadow-lg), 0 0 0 1px rgba(188,19,254,0.12); transform: rotate(1.6deg); animation: rx-float 7s ease-in-out infinite; }
  @keyframes rx-float { 0%, 100% { transform: rotate(1.6deg) translateY(0); } 50% { transform: rotate(1.6deg) translateY(-10px); } }
  .rx-kiosk-venue { font-size: 9.5px; font-weight: 600; letter-spacing: 0.12em; text-transform: uppercase; color: rgba(188,19,254,0.75); margin-bottom: 10px; }
  ...
  .rx-kprog-fill { height: 100%; width: 0; background: linear-gradient(90deg, #7A0CA5, #BC13FE); border-radius: 2px; transition: width 0.55s cubic-bezier(0.4,0,0.2,1); }
  ...
  @keyframes rx-kpulse { 0%, 100% { border-color: rgba(255,255,255,0.09); } 50% { border-color: rgba(188,19,254,0.4); } }
  ...
  .rx-showcase::before { content: ''; position: absolute; inset: 0; background-image: radial-gradient(circle, rgba(188,19,254,0.05) 1px, transparent 1px); background-size: 30px 30px; pointer-events: none; }
  ...
  .rx-show-card:hover { transform: translateY(-5px); border-color: rgba(188,19,254,0.35); }
  ...
  .rx-team-vis::after { content: ''; position: absolute; top: -50px; right: -50px; width: 180px; height: 180px; background: radial-gradient(circle, rgba(188,19,254,0.14) 0%, transparent 70%); pointer-events: none; }
  .rx-vis-label { font-size: 9.5px; font-weight: 600; letter-spacing: 0.12em; text-transform: uppercase; color: rgba(188,19,254,0.8); margin-bottom: 16px; }
  ...
  .rx-feat-card:hover { transform: translateY(-5px); box-shadow: var(--shadow-lg); border-color: rgba(188,19,254,0.4); }
  ...
  .rx-pbtn-neon:hover { background: #CD4EFE; }
  ...
  .rx-cta::before { content: ''; position: absolute; inset: 0; background: radial-gradient(ellipse at center, rgba(188,19,254,0.12) 0%, transparent 68%); pointer-events: none; }
        ...
        <div className="rx-hero-inner">
          ...
          <div>
            <div className="rx-kiosk-card">
              ...
              {completed === total && (
                <div className="rx-kactive" style={{ borderColor: "rgba(188,19,254,0.4)" }}>
                  <svg width="12" height="12" viewBox="0 0 12 12" fill="none" stroke="#BC13FE" strokeWidth="2" strokeLinecap="round"><polyline points="1.5 6 4.5 9 10.5 3"/></svg>
                  <span className="rx-kactive-text" style={{ color: "rgba(188,19,254,0.9)" }}>Shift complete — all tasks done</span>
                </div>
              )}
            </div>
          </div>
