 ...
 * white + teal blue (#00E5CC) skin. Local preview only, not linked from any nav.
 */
...
const css = `
  ...
  .rx-tag {
    ...
    text-transform: uppercase; color: var(--ink); background: rgba(0,229,204,0.55);
  ...
  .rx-cta::before { content: ''; position: absolute; inset: 0; background: radial-gradient(ellipse at center, rgba(0,229,204,0.12) 0%, transparent 68%); pointer-events: none; }
