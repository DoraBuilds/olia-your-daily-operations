...
import { Plus, Search, ChevronDown, X, GripVertical, MoreVertical, FolderPlus, ClipboardList, Eye } from "lucide-react";
...
export function ChecklistsTab() {
  ...
  const handleContextAction = (action: string) => {
    ...
    if (action === "move") {
      ...
      if (contextMenu.type === "folder") deleteFolderMut.mutate(contextMenu.id);
      else deleteChecklistMut.mutate(contextMenu.id);
